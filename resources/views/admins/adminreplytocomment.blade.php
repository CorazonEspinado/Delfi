...
<div class="well">
                    ...
                    <form role="form" method="POST" action="{{route('AdminCommentReplyStore', 
                                        ['post_id'=>$post_id,
                        ...
                        <input type="text" class="form-control" id="name" name="replyname1" value="Модер" disabled="">
                        <input type="hidden" value="Модер" name="replyname">
